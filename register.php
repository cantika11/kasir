                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmail" type="text" name="nama" placeholder="Masukkan Nama Lengkap"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail">Username</label>
                                                <input class="form-control py-4" id="inputEmail" type="text" name="username" placeholder="Masukkan Username"/>
                                            </div>
                                            <div class="form-group">
